...
export function StatsCard({ title, value, unit, delta, sparkData, color = 'hsl(var(--primary))', warning }: StatsCardProps) {
      ...
      <div className="flex items-start justify-between mb-2">
        ...
        {delta !== undefined && (
          <div className={cn(
            ...
            delta > 0 ? "text-signal-green" : delta < 0 ? "text-signal-red" : "text-muted-foreground"
          )}>
