      ...
      {adminTab === "config" && (
        <div className="space-y-4">
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
            ...
            <p className="text-xs text-muted-foreground">
              Most settings are read-only in this demo. In production, admins can adjust
              model parameters, thresholds, retention policies, and notification settings.
            </p>
          </div>
